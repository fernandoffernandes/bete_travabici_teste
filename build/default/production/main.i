...
# 130 "./header_files/defines.h"
const uint32_t CAN_ID_TX_VALIDATION_M1 = 0x16000000;
const uint32_t CAN_ID_TX_VALIDATION_M2 = 0x16000001;
const uint32_t CAN_ID_TX_VALIDATION_M3 = 0x16000002;
const uint32_t CAN_ID_TX_VALIDATION_M4 = 0x16000003;
const uint32_t CAN_ID_TX_VALIDATION_M5 = 0x16000004;
const uint32_t CAN_ID_TX_VALIDATION_M6 = 0x16000005;
# 159 "./header_files/defines.h"
typedef struct
{
    _Bool dock_sensor;
