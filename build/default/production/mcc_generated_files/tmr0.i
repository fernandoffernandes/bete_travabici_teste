...
# 1 "mcc_generated_files/../header_files/defines.h" 1
# 58 "mcc_generated_files/../header_files/defines.h"
typedef struct
{
    _Bool dock_sensor;
...
extern uint16_t g_wait_time;

extern _Bool g_flag_timer_1s;
extern _Bool g_flag_timer_100ms;
...
void TMR0_ISR(void)
{
    ...
    g_flag_timer_100ms = !g_flag_timer_100ms;
    ...
    if(counter_1s == 0)
    {
        ...
        g_flag_timer_1s = !g_flag_timer_1s;
    }
    else
        counter_1s--;
}
